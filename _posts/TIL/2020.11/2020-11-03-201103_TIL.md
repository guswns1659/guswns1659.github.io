...
역시 책을 읽어야 한다. 오랜시간 붙들고 있는 책, 소프트웨어 장인 책을 읽으니 다시금 개발자의 자세에 대해서 생각해보게 된다. 이런 걸보면 시간을 내서라도 책을 읽어야겠다. 집이 힘들다면 주말엔 카페 가는 시간을 만들어서 가는 것도 방법이겠다. 이 때는 아래와 같은 개발 철학을 이야기하는 책이 좋을 것 같다. XP, 실용주의 프로그래머
