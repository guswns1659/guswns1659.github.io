...
## 인텔리j에서 unsolved database references in annotations 체크 해제 하는 법
- Settings -> Editor -> inspections -> uncheck unresolved database references in annotations
- [참고 : 스택오버플로우](https://stackoverflow.com/questions/58666411/cannot-resolve-table-xx-in-spring-boot-application)
