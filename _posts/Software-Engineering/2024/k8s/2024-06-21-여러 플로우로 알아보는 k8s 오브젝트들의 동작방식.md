...
- **gRPC 기반 통신**: CRI는 gRPC를 사용하여 kubelet과 컨테이너 런타임 간의 통신을 수행합니다. 주요 서비스에는 `RuntimeService`와 `ImageService`가 포함됩니다.
...
- **호환성 보장**: OCI 표준을 따르면 다양한 컨테이너 런타임이 일관되게 동작할 수 있습니다. 이는 컨테이너의 포터빌리티와 호환성을 보장합니다.
