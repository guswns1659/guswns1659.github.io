...
![img.png](https://github.com/user-attachments/assets/ea87ddf1-9797-4a83-8871-d5e59bd997ee) (출처: [https://docs.kublr.com/logging/logging-kibana/](https://docs.kublr.com/logging/logging-kibana/))
 
* **메트릭 (Metrics)** 은 CPU·메모리 사용량, 응답 시간, 처리 건수처럼 수치로 표현되는 데이터입니다. 시계열로 수집하여 추세를 파악하고, 성능 저하나 리소스 부족 같은 이상 징후를 빠르게 감지할 수 있습니다.
 
![img_2.png](https://github.com/user-attachments/assets/4ea7e04e-fcac-47ed-a0be-f8672e47d988) (출처: [https://learn.microsoft.com/en-us/azure/azure-monitor/app/overview-dashboard?utm_source=chatgpt.com](https://learn.microsoft.com/en-us/azure/azure-monitor/app/overview-dashboard?utm_source=chatgpt.com))
...
![img_1.png](https://github.com/user-attachments/assets/d494cce0-5dfb-441b-9dc7-644cddcf2733) (출처: [https://blog.risingstack.com/distributed-transaction-tracing-microservices-monitoring/](https://blog.risingstack.com/distributed-transaction-tracing-microservices-monitoring/))
...
![img_5.png](https://github.com/user-attachments/assets/e0b45919-93e2-4069-9917-98301dac442e) (출처: [https://micrometer.io/](https://micrometer.io/))
...
![img_4.png](https://github.com/user-attachments/assets/7f01ee05-2708-4bf1-94d2-f0c12e9de3a7)
